...
public class StringDistance {
	...
	/*
	 * Kudos http://www.merriampark.com/ldjava.htm
	 * Chas Emerick
	 */
	public static int getLevenshteinDistance(String s, String t) {
		 ...
		 * distance cost
		 * counts as we iterate through the characters of String s. Each time we
		 * increment
		 * the index of String t we are comparing, d is copied to p, the second
		 * int[]. Doing so
		 * allows us to retain the previous cost counts as required by the
		 * algorithm (taking
		 * the minimum of the cost count to the left, up one, and diagonally up
		 * and to the left
